...
import com.v5foradnroid.userapp.post.SessionHandler;
...
import com.v5foradnroid.userapp.utilities.SharedPref;
...
public class ActivityCheckout extends AppCompatActivity {
    ...
    String playerId;
    TextView PaymentVar;
    private String Json_Url, var_twoe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Json_Url = getPref23("fourth", getApplicationContext());
    ...
    private void getSpinnerData() {
        ...
        StringRequest stringRequest = new StringRequest(var_twoe + "/api/api.php?get_shipping", new Response.Listener<String>() {
            @Override
...
//        str_phone = edt_phone.getText().toString();
    ...
    public void requestAction() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, var_twoe+"/api/api.php?post_order", new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("server_url", var_twoe);
                return params;
            }
    ...
    public void dialogSuccessOrder() {
        ...
        builder.setPositiveButton(R.string.checkout_option_ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(getApplicationContext(), StoreMainAc.class);
